...
User.create(
    name: "李华",
    email: "lijiaoyang19@mails.ucas.ac.cn",
    num: "201928008629001",
    major: "计算机技术",
    department: 9,
    password: "password",
...
(1..200).each do |index|
  ...
  student=User.create!(
      ...
      num: "2019#{Faker::Number.number(11)}",
      major: department_map[dept][:major_name].sample,
      department: dept,
      student_class: 20190713,
      reset: false,
      password: "password",
      password_confirmation: "password",
  )
...
#     title:"关于向海内外校友及社会各界征集校史资料的公告",
#     text:"

# （中国科学院大学40周年校庆公告002号）

#     2019年是中国科学院大学（简称“国科大”）建校四十周年，为客观记录和展示学校教育发展历程，探寻办学历史及文化内涵，全方位展示学校办学特色及育人成果，传承学校文化，弘扬学校传统，国科大决定筹建新校史馆，现向全体师生、离退休职工及家属、海内外校友和社会各界人士广泛征集校史资料。具体征集内容如下。

# 一、基本要求

#     所提交的校史资料应尊重学校的历史事实，要求线索清晰、考证翔实、准确无误，能反映学校不同时期的办学历史和成就，展示学校的形象风貌和社会影响力。

# 二、征集内容

#     1. 文字资料

#     （1）不同历史时期对学校建设和发展有重大影响的文件资料；

#     （2）各类重大活动、会议的新闻稿件和记录资料；

#     （3）具有历史意义的报告、批复、任命书、会议纪要等文件资料。

#     2. 图片资料

#     （1）曾经或目前在学校担任教师的中国科学院院士、中国工程院院士（以下简称“两院院士”）、曾就读于学校的“两院院士”等知名校友的图片（不小于350dpi），并附出生年月、籍贯、在学校担任教师或就读的起止年月、研究领域信息；

#     （2）历届毕业生合影照片、毕业纪念册、同学名录、师生间赠言、题录等；
...
#     （1）国家级领导人调研指导工作的录音、影像资料；

#     （2）学校各类重大活动的录音、影像资料；

#     （3）“两院院士”在教学活动中的录音、影像资料；

#     （4）国内外著名学者及政要在学校开展、参与各类报告和活动的录音、影像资料。

#     4. 实物资料

#     （1）曾就读于学校的“两院院士”等知名历届校友的学籍资料，含学位证、毕业证、报考材料、成绩单、开题报告、中期考核报告、学位论文及各类学籍信息材料等；

#     （2）曾经或目前参加授课的“两院院士”的著作、手稿、笔记、聘书、教案、考卷及主编的教材等；

#     （3）学校师生在各时期参加的国家级重大科研项目所使用的仪器设备及相关模型等；

#     （4）学校师生在各时期获国家自然科学奖、国家技术发明奖和国家科技进步奖及其他重大奖项的获奖证书、奖杯等；

#     （5）学校办学早期制作或使用的教具、模型等；

#     （6）师生员工在校期间使用过的印章、校徽、校标、个人证件（如：工作证、学生证、借书证、毕业文凭、学位证书、毕业分配派遣证等）、纪念章、票证、录取通知书，及具有时代特色或代表性的作业本、笔记本等；

#     （7）单位或个人赠送给学校的反映重要活动的纪念品等；

#     （8）带有学校不同时期校名印记的物品等。

#     5. 其他资料

#     其他各类能反映学校教育历程及展示科教融合育人成果的校史资料。

# 三、征集方式

#     1. 无偿捐赠：对有意将收藏的校史资料无偿捐赠给国科大者，国科大校史馆将颁发捐赠证书以作永志；

#     2. 有偿征集：对于一些具有历史价值、不可复制的实物资料，经专家鉴定、学校研究后可进行有偿征集；

#     3. 代管、复制：对特别珍贵的校史资料，如收藏者有意继续保存者，国科大可代为保管，或复制、翻拍后将原件安全归还。

# 四、征集说明

#     1. 征集的校史资料，提供人可亲自送至国科大，国科大亦可上门接收，文字、图片、影音资料可邮寄或发送电子邮件到联系邮箱；

#     2. 图片和影音等资料请附简要的文字说明，含事件时间、地点、事项、主要参加人的姓名、时任职务、拍摄（提供）人姓名、现从事职业等信息；

#     3. 所征集的校史资料，由国科大校史馆统一造册、统一管理和展示；

#     4. 个人提供的校史资料，请提供人注明是否愿意捐赠，对于不便捐赠的校史资料，请在送交时明确说明，国科大将原件复制后退还提供人。

#     5. 所有征集的校史资料，均与提供人签订征集协议，注明征集方式等内容。

# 五、征集时间

#     1. 常年征集反映学校教育历程及办学特色的校史资料；

#     2. 对于有意愿在国科大校庆活动日（2019年10月14日）展示的校史资料，请提供者于2019年3月16日前联系国科大校史馆或校友会办公室，办理送交手序。
...
#     邮  箱：archives@ucas.edu.cn

#     地  址：中国科学院大学雁栖湖校区校史馆(北京市怀柔区怀北镇怀北庄380号 101408)    

#     联系人：孙老师

#     电  话：010-88256393

#     邮  箱：ucasaa@ucas.edu.cn

#     地  址：中国科学院大学玉泉路校区校友会办公室 (北京市石景山区玉泉路19号甲 100049)
...
#     2019年全国硕士研究生入学考试将于2019年12月23-24日举行，我校是考点之一。

#     为保证国家教育考试的顺利进行，决定从2019年12月22日17：00开始至23日18：00，对中关村教学楼进行封闭；从12月22日17：00开始至24日18：00，对玉泉路教学楼（含辅楼阶梯教室）和人文楼进行封闭。封闭期间，与考试无关的人员一律不得进入封闭区域。

#     考试期间，禁止在考场及周围大声喧哗，禁止在考场周边组织文艺、体育、学术等群体活动。
...
# Inform::Article.create!(
#     title:"关于举行中国科学院大学2019级新生开学典礼的通知",
#     text:"

# 各研究所：    中国科学院大学定于2019年9月10日（星期日）上午9:00，在雁栖湖校区图书馆楼前广场，举行2019级新生开学典礼。典礼由中科院副院长、国科大校长丁仲礼院士主持，中科院院长、国科大名誉校长白春礼院士出席并讲话。    建议京外研究所组织学生通过点击中国科学院大学中文网首页的飘窗收看开学典礼视频直播，或结合本单位实际情况自行组织开学典礼。    视频直播调试时间：2019年9月9日15:00至18:00，请各所测试收看效果，有问题及时反馈。特此通知。                   中国科学院大学                   2019年9月6日 
# "
# )


# Inform::Article.create!(
#     title:"2019年1月份医药费报销通知",
#     text:"

# 门诊部定于近日进行2019年1月份医药费报销工作，具体时间安排如下：



# 玉泉路校区

# 离 退 休：  2019年1月16日、17日
...
# 至此，2018年门诊医药费报销工作全部结束，请大家务必将2018年发生的医药费在此次及时报销，逾期不予报销!!
...
#         根据《普通高等学校学生管理规定》（教育部令第21号）、《教育部办公厅关于进一步规范普通高等学校转学工作的通知》（教学厅[2015]4号）和北京市教委相关规定，现将陈子涵的转学申请予以公示，公示时间从2018年12月5日8:00起至2018年12月10日17:00止。若对陈子涵转学有异议，请于2018年12月10日17:00前以书面形式向学生处反映，反映情况时应实事求是，并署真实姓名及联系方式。
...
# )
# Inform::Article.create!(
#     title:"2018年12月份医药费报销通知 ",
#     text:"

# 门诊部定于近日进行2018年12月份医药费报销工作，具体时间安排如下：



# 玉泉路校区

# 离 退 休：  2018年12月27日、28日

# 在职、学生：2018年12月20日、21日
...
# 特此提示！2018年11月10日全国正式实行，请转告你身边的朋友！千万注意！
...
# 1．时间：2018年11月3日（周四）12:30-----15:00
...
# 由中国教育国际交流协会主办的第八届2016博士生招生面试交流会/PhD Workshop China 2016将分别于2018年11月19日-20日在北京喜来登长城饭店和11月22日在上海花园饭店举办。
...
# 三、凭打印出的参会确认函邮件入场参会。注册截止日期：2018年11月15日。
...
# )
# Inform::Article.create!(
#     title:"国科大关于2019年下半年全国大学英语考试四六级报名的通知 ",
#     text:"
...
# 根据教育部考试中心及北京市教育考试指导中心部署，现将本次我校2018年下半年大学英语四、六级考试报名工作的具体安排通知如下：



# 一、考试时间及地点

# 大学英语四级考试（CET4）:2018年12月17日上午9:00 – 11:20；

# 大学英语六级考试（CET6）:2018年12月17日下午15:00 –17:25；
...
# 4. 2018年6月参加六级考试的学生（包括通过、未通过、无故缺考、网上报名成功但不缴费的），本次不能报考六级考试。
...
# 1.因学校考位有限，仅有750个考位。根据2018年上半年六级考试通过率情况，六级报考名额中为2014级本科生分配50名，2015级200名，研究生分配500名。报考四级本科生优先。
...
#          根据校领导指示，从2018年9月5日起开通玉泉路校区及中关村校区间早晚学生市内摆渡车，现就有关事项通知如下：
...
# )
# Inform::Article.create!(
#     title:"关于统计2019年中秋节国庆节慰问品的通知 ",
#     text:"

# 校属各单位、各部门工会小组：

#     2018年中秋节国庆节即将到来，为做好“节日慰问品”发放工作，计划分别在雁栖湖校区、玉泉路校区、中关村青年公寓、中关村教学楼四处发放，现将有关事宜通知如下：
...
#     为了方便会员领取慰问品，请各单位统计每位会员领取的地点，填报“2018年中秋节国庆节慰问品登记表”，于9月8日前将登记表电子版发至工会jiangchuan@ucas.ac.cn邮箱。

#      “2018年中秋节国庆节慰问品登记表”请见附件。
...
# )
# Inform::Article.create!(
#     title:"2019年研究生新生入学体检通知（雁栖湖校区）",
#     text:" 定于8月30日（周二）至9月5日（周一）进行2016级研究生新生入学体检工作，具体安排如下：

# 一、参加人员：2019级雁栖湖校区全体研究生新生
